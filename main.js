(function () {
  ...
  // NOTE LẠI: Thay đổi tọa độ Lạc Thư chuẩn
  var PALACE_META = {
  ...
  // NOTE LẠI: Vẽ HTML Grid theo thứ tự bảng 3x3 Lạc Thư (Tốn 4, Ly 9, Khôn 2...)
  ...
  function renderInfo(chart){
    ...
    var html = `
      <!-- DÒNG 1 -->
      <div class="kv"><div class="k">Hệ thống :</div><div class="v" style="font-weight:bold; color:var(--accent);">Lạc Thư Cửu Cung</div></div>
  ...
  function calculate(){
    try{
      if(!window.BanKyMonLacThu){ alert('Không tải được engine Lạc Thư.'); return; } // Cập nhật gọi biến
      ...
      var chart = window.BanKyMonLacThu.byDatetime(dtStr, options);
