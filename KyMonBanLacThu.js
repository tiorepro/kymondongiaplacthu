...
(function (root, factory) {
  if (typeof module !== 'undefined' && module.exports) {
    ...
    root.BanKyMonLacThu = factory(); // NOTE LẠI: Tên hàm gốc
  }
  ...
  // NOTE LẠI: Mapping chuẩn Lạc Thư
  const CUNG_META = {
  ...
  // NOTE LẠI: Phân bổ sao chuẩn Lạc Thư
  ...
  // NOTE LẠI: Phân bổ cửa chuẩn Lạc Thư
  const MON_THEO_CUNG = { 1:'Hưu', 2:'Tử', 3:'Thương', 4:'Đỗ', 5:'', 6:'Khai', 7:'Kinh', 8:'Sinh', 9:'Cảnh' };

  // NOTE LẠI: Quỹ đạo xoay Lạc Thư (Khảm-Cấn-Chấn-Tốn-Ly-Khôn-Đoài-Kiền)
  ...
  // NOTE LẠI: Đại diện Chi của Cung Lạc Thư
  ...
  // NOTE LẠI: Trục đối xung Lạc Thư
  ...
  // NOTE LẠI: Điều chỉnh Lục Nghi Kích Hình cho Lạc Thư
  ...
  function tinhCachCuc(tb, db, bm, bt, tcb) {
    ...
    for (let cung = 1; cung <= 9; cung++) {
      ...
      // NOTE LẠI: Thanh Long Phản Thủ ở Lạc Thư là cung Chấn(3) và Ly(9)
